  ...
  return (
    <div id="contact_us" className="contact">
            <div className="text-center">
                ...
                <p className="para-data"> Thank you for having a look at our company website. Please reach out to us for any quesry or suggestions.</p>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="row">
                        <div className="form">
                            ...
                            <button className="btn-main-offer contact-btn mb-5" type="submit">Contact Us</button>
                        </div>
